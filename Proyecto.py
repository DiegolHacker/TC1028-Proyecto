...
def caracter_por_caracter(texto):  #Esta función se encarga de que el texto sea impreso caracter por caracter.
    for char in texto:
        print(char, end='')     #Imprimir cada caracter sin salto de línea.
        sys.stdout.flush()     #Imprimir el bus de la consola constantemente, para no esperar a que se complete un bloque (en este caso una palabra) para mandarse a imprimir.
        time.sleep(0.02)        #Espera 0.02 segundos entre cada impresión de caracter, delay de 0.02 segundos = 50 caracteres por segundo.
...
while jugar: #el juego se ejecutara mientras la condición de jugar sea cierta.
    ...
    x = 10 #Largo del tabero.
    y = 2 #ancho del tablero.
    z = 0       #las variables z son contadores para los ciclos de impresión y de validación.
    z2 = 0
    z3 = 0
    mayor = 0
    menor = 0
    ...
    valido = False
    while valido == False:
        n1 = int(input("Número 1:"))   #Pide el número al jugador.
        if n1 > 0 and n1 < 10: #Comprueba que el número se encuentre dentro del rango de 1 a 9.
            valido = True
        else:
    ...
    while valido == False:
        ...
        if (n2 + 1 == n1 or n2 - 1 == n1) and n2 != 10 and n2 != 0:    #Comprueba que el segundo número sea contiguo al primero y que no exceda el límite.
            valido = True
        else:
            valido = False
            print("Número inválido")
...
#==========================================================================================================
    ...
    with open("score.txt", "w") as file:
        file.write(str(puntos_max)) #Sobreescribe el puntaje máximo.

    a = input(" ")
    if a == "x":
        jugar = False #Detiene el programa.
